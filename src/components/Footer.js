  ...
  return (
    <nav className="first-conti">
      ...
      <div className="ig-div">
        <a href="https://www.instagram.com/arena.aiii">
          <img
      ...
      <div className="whatsapp-div">
        <a href={`tel:${phoneNumber}`}>
          <img src={call} alt="whatsapp" className="whatsapp" />
        </a>
        <a href={`tel:${phoneNumber}`}>
        <h5>Call Amy</h5>
        </a>
      ...
      <div className="whatsapp-div">
        <a href={`sms:${phoneNumber}`}>
          <img src={text} alt="whatsapp" className="whatsapp" />
        </a>
        <a href={`sms:${phoneNumber}`}>
        <h5>Text Amy</h5>
        </a>
